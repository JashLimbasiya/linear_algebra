      ...
      child: Scaffold(
          ...
          body: Container(
            ...
            child: GridView.count(
              ...
              crossAxisCount: 2,
              children: <Widget>[
                CardView("Geometry", 'lib/assets/images/geometry/geometry.png','g'),
                CardView(
                    "Linear Systems", 'lib/assets/images/linear_system/linear_equation.png','ls'),
                CardView("Matrices", 'lib/assets/images/matrices/matrices.png','m'),
                CardView(
                    "Vector Spaces", 'lib/assets/images/vector_spaces/vector_spaces.png','vs'),
              ],
            ),
          )),
    );
